...
},{"./transport":11,"./transports/index":12,"component-emitter":7,"debug":18,"engine.io-parser":21,"indexof":26,"parseqs":29,"parseuri":30}],11:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":7,"engine.io-parser":21}],12:[function(require,module,exports){
/**
 * Module dependencies
 */
...
},{"../transport":11,"component-inherit":8,"debug":18,"engine.io-parser":21,"parseqs":29,"xmlhttprequest-ssl":17,"yeast":45}],16:[function(require,module,exports){
(function (Buffer){
/**
 * Module dependencies.
 */
...
},{"../transport":11,"buffer":54,"component-inherit":8,"debug":18,"engine.io-parser":21,"parseqs":29,"ws":53,"yeast":45}],17:[function(require,module,exports){
...
},{"./common":19,"_process":56}],19:[function(require,module,exports){
...
},{"buffer":54,"isarray":27}],25:[function(require,module,exports){
...
},{"./on":33,"./socket":34,"backo2":3,"component-bind":6,"component-emitter":7,"debug":36,"engine.io-client":9,"indexof":26,"socket.io-parser":40}],33:[function(require,module,exports){
...
},{"./on":33,"component-bind":6,"component-emitter":7,"debug":36,"has-binary2":24,"parseqs":29,"socket.io-parser":40,"to-array":44}],35:[function(require,module,exports){
...
},{"./common":37,"_process":56,"dup":18}],37:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"dup":19,"ms":38}],38:[function(require,module,exports){
...
},{"./binary":39,"./is-buffer":41,"component-emitter":7,"debug":42,"isarray":27}],41:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":54}],42:[function(require,module,exports){
(function (process){
/**
 * This is the web browser implementation of `debug()`.
 *
...
},{"./debug":43,"_process":56}],43:[function(require,module,exports){
...
},{"ms":28}],44:[function(require,module,exports){
...
const lineColor =  consts.GRID_LINE_COLOR;
const boxBorderColor = consts.BOX_BORDER_COLOR;

//Draw a single line in canvas context
const drawLine = function(ctx,p1,p2,color) {
    ctx.beginPath();
...
//Draw game grids
const drawGrids = function(el,gridSize,colCount,rowCount,color1,color2){
...
const drawBox = function(ctx,color,x,y,gridSize) {
    if (y < 0){
        return;
    }
...
const tetrisCanvas = {
	...
	//Clear game canvas
	clearSceneOther:function(){
		this.otherPlayerContext.clearRect(0, 0, this.otherPlayer.width, this.otherPlayer.height);
	},
    //Draw game scene on other player canvas, grids
	drawSceneOther:function(){
        this.i++;
		this.clearSceneOther();
		drawGrids(this.otherPlayer,this.otherPlayerSize,
			consts.COLUMN_COUNT,consts.ROW_COUNT,
			consts.SCENE_BG_START,consts.SCENE_BG_END);
	},
	//Draw game data on other player canvas
	drawMatrixOther:function(matrix){
		for(var i = 0;i<matrix.length;i++){
			var row = matrix[i];
			for(var j = 0;j<row.length;j++){
				if (row[j]!==0){
					drawBox(this.otherPlayerContext,row[j],j*this.otherPlayerSize,i*this.otherPlayerSize,this.otherPlayerSize);
				}
			}
		}
	},
	//Draw acitve shape on other player canvas
	drawShapeOther:function(shape){
		if (!shape){
			return;
		}
		var matrix = shape.matrix();
		var gsize = this.otherPlayerSize;
		for(var i = 0;i<matrix.length;i++){
			for(var j = 0;j<matrix[i].length;j++){
				var value = matrix[i][j];
				if (value === 1){
					var x = gsize *(shape.x + j);
					var y = gsize *(shape.y + i);
					drawBox(this.otherPlayerContext,shape.color,x,y,gsize);
				}
			}
		}
	}
...
},{"./consts.js":47,"./utils.js":50}],47:[function(require,module,exports){
...
},{"./canvas.js":46,"./consts.js":47,"./shapes.js":49,"./utils.js":50,"./views.js":51,"socket.io-client":31}],49:[function(require,module,exports){
var consts = require('./consts.js');
...
ShapeZR.prototype = {
	...
	init:function(color, state, allBoxes, y){
...
},{"./consts.js":47}],50:[function(require,module,exports){
...
var searchingPlayers = $('searchingPlayers');
...
var layoutView = function(container,maxW,maxH){
	...
	//layout other player scene
	otherPlayer.height = 400;
	otherPlayer.width = otherPlayer.height / 2;
	...
	startGame.style.width = scene.width +'px';
	searchingPlayers.style.width = scene.width +'px';
...
var tetrisView = {
    ...
    setMainMenu:function(){
        searchingPlayers.style.display = 'none';
        otherPlayer.style.display = 'none';
        startGame.style.display = 'block';
    },
    // When the game starts
    setSeachingPlayers:function(){
        startGame.style.display = 'none';
        searchingPlayers.style.display = 'block';
        otherPlayer.style.display = 'block';
    },
    // When the game starts
    setGameStart:function(multiplayer){
        if(multiplayer) {
            searchingPlayers.style.display = 'none';
        } else {
            startGame.style.display = 'none';
	...
	// Set game over view
	setGameOver:function(isGameOver, win = false){
        if(isGameOver) {
            verdict.innerHTML = win ? 'You Win!!' : 'You Lose!!';
...
},{"./consts.js":47,"./utils.js":50}],52:[function(require,module,exports){
'use strict'
